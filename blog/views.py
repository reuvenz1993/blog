...
from blog.forms import LoginForm , SignupForm, AddPost , UpdateForm
...
def user():
    ...
    return render_template('account.html', user=user, posts=posts , email=email , updateform=updateform , addpost_form=addpost_form)